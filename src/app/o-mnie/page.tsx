      ...
      <div className="max-w-4xl mx-auto px-5 lg:px-8">
        <Reveal>
          ...
          <div className="mt-5 inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#0891B2]/30 bg-[#0891B2]/5">
            <span className="font-mono-tech text-[12px] text-[#0891B2] font-semibold">O MNIE</span>
          </div>
        ...
        <Reveal delay={0.1}>
          <Link
            href="/sterowniki"
            className="mt-14 inline-flex items-center gap-2 text-[#0891B2] font-semibold text-sm hover:underline"
          >
