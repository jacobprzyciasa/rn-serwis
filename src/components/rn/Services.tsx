      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <Reveal delay={0.1}>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 text-center p-7 rounded-xl border border-black/8 bg-white">
            ...
            <a
              href="#kontakt"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-md border border-[#0891B2]/40 text-[#0C6E86] font-semibold text-sm hover:bg-[#0891B2] hover:text-white transition-colors whitespace-nowrap"
            >
              Zapytaj o naprawę
